...
class ServerRequest extends Request implements ServerRequestInterface
{
    ...
    public function __construct(
        ...
        $this->servers = new ParameterStore($servers);
        $this->cookies = new ParameterStore($cookies);
        $this->queryParams = new ParameterStore($queryParams);
        $this->files = new ParameterStore($files);
        $this->attributes = new ParameterStore($attributes);
        $this->parsers = new ParameterStore($this->getDefaultParsers());

        parent::__construct($headers, $body, $protocolVersion, $requestTarget, $method, $uri);
    }
